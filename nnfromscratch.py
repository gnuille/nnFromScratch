...
###### for generate dataset ##############################
#we take array of 4 bits [x1, x0, y1, y0]
#and we want the sum in a 3 bit array
...
def run():
    ...
    nn = neuralNetwork(
                 ...
                 hidden_neurons1=100,
                 hidden_neurons2=50,
                 nHidden_layers=2, #not very usefull for this problem, it just reduces eficiency
                 output_neurons=3,
